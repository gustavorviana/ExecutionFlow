...
public class ContextTests
{
    ...
    public void ExecutionContext_Exposes_Log_Property()
    {
        ...
        var context = new FlowContext(new Dictionary<string, object>(), logger);
    ...
    public void ExecutionContext_TEvent_Exposes_Event_Property()
    {
        ...
        var context = new FlowContext<TestEvent>(new Dictionary<string, object>(), logger, evt);
    ...
    {
        var logger = Substitute.For<IExecutionLogger>();
        var context = new FlowContext<TestEvent>(new Dictionary<string, object>(), logger, new TestEvent());
